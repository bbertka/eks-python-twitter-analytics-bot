...
* link:#part-4---deploy-twitterbot[Part 4 - Deploy Bot]
...
twitterbot-ingress   <none>   *       58c8349a-default-rundeckin-89de-245843308.us-east-2.elb.amazonaws.com   80      3d1h
----
...
+
----
$ kubectl apply -f twitterbot-deployment.yaml
----
